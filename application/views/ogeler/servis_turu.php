<div class="form-group<?php if(isset($sifirla)) {echo " p-0 m-0";} ?> col">
    <select id="servis_turu" class="form-control" name="servis_turu" aria-label="Servis Türü">
        ...
        <option value="3"<?php if(isset($value) && $value==3) {echo " selected";} ?>><?= $this->Islemler_Model->servisTuru(3); ?></option>
        <option value="4"<?php if(isset($value) && $value==4) {echo " selected";} ?>><?= $this->Islemler_Model->servisTuru(4); ?></option>
    </select>
</div>