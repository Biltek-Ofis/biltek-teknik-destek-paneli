...
class _DetaylarGaleriState extends State<DetaylarGaleri> {
            ...
            case 0:
              if (widget.duzenle) {
                ...
                islemYapilamazDialog(
                  title: "Eklenemez",
                  content: "Cihaz düzenleme tamamlandığı için resim eklenemez!",
                );
              }
              break;
            case 1:
  ...
  void islemYapilamazDialog({required String title, required String content}) {
    showDialog(
      context: context,
          ...
          showDialog(
            ...
            builder: (context) {
              return AlertDialog(
                title: Text("Başarısız"),
                content: Text(
                  "Medya silinemedi lütfen daha sonra tekrar deneyin.",
                ),
                actions: [
                  TextButton(
                    onPressed: () {
