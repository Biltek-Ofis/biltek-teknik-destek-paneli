...
class TakvimSecici extends StatefulWidget {
  ...
  /// onConfirm will return when save button tapped
  final Function(DateTime?)? onConfirm;

  /// Background effects will make attractive
  final TarihSeciciArkaplan backgroundEffects;
  ...
  /// Creates an instance of [TakvimSecici].
  ///
  ...
  const TakvimSecici({
    ...
    this.brandIcon,
    this.backgroundEffects = TarihSeciciArkaplan.none,
    this.action = false,
  ...
  @override
  State<TakvimSecici> createState() => _TakvimSeciciState();
}

class _TakvimSeciciState extends State<TakvimSecici> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget actionButton = GestureDetector(
        onTap: () {
          ...
          returnDate ??= _selectedDate;
          widget.onConfirm?.call(returnDate);
