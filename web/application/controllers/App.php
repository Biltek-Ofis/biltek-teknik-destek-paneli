...
class App extends CI_Controller
{
        ...
        if (isset($token)) {
            if ($this->token($token)) {
                ...
                if ($ku != null) {
                    ...
                    $cihaz = $this->Cihazlar_Model->tekCihazApp($no);
                    if ($cihaz != null) {
    ...
    public function tekCihazNoAuth()
    {
        // Auth'da gerek yok
        $this->headerlar();
        $token = $this->tokenPost();
            ...
            if ($this->token($token)) {
                ...
                if ($ku != null) {
                    if ($ku->musteri != 1) {
                        ...
                        if (isset($cihaz_id)) {
                            $yukle = $this->Cihazlar_Model->medyaYukle($cihaz_id, $ku->id);
                ...
                if ($ku != null) {
                    if ($ku->musteri != 1) {
                        ...
                        if (isset($cihaz_id)) {
                            ...
                            $sil = $this->Cihazlar_Model->medyaSil($cihaz_id, $ku->id);
                            if ($sil) {
                                if ($medya != null) {
    ...
    public function cihazEkle()
    {
        ...
        if (isset($token)) {
            if ($this->token($token)) {
                ...
                if ($ku != null) {
                    if ($ku->musteri != 1) {
                        $ekle = $this->Cihazlar_Model->cihazEkle("POST", $ku->id);
        ...
        if (isset($token)) {
            if ($this->token($token)) {
                ...
                if ($ku != null) {
                    $id = $this->input->post("id");
                    if (isset($id)) {
                        $this->Cihazlar_Model->cagriDurumGuncelle($ku->id, $id, "Fiyat Onaylandı", "fiyatonay");
                    } else {
                        echo json_encode($this->hataMesaji(1));
                    }
                } else {
        ...
        if (isset($token)) {
            if ($this->token($token)) {
                ...
                if ($ku != null) {
                    $id = $this->input->post("id");
                    if (isset($id)) {
                        $this->Cihazlar_Model->cagriDurumGuncelle($ku->id, $id, "Fiyat Onaylanmadı", "fiyatret");
                    } else {
                        echo json_encode($this->hataMesaji(1));
                    }
                } else {
