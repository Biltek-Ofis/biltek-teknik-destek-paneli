...
<table class="table col-5">
    ...
    <tbody>
        ...
        <tr>
            <td style="border: 0 !important;">4. Servis formu ibrazı ile sadece cihaz kaydı yaptıran kişiye teslim
                edilebilir. Onun dışında Kimlik Fotokobisi ve cihazı kaydettiren kişinin onay yazısı ile ilgili kişiye
                teslim edilebilir.</td>
        </tr>
        <tr>
            <td style="border: 0 !important;">5. Onarım için servise getirilen cihazların arıza tespiti yapıldıktan
                sonra onarıma onay verilmemişse {arıza_tespit_ucreti} tutarında arıza tespit ücreti alınır.</td>
        </tr>
        <tr>
            <td style="border: 0 !important;">6. BİLDİRİLEN DOSYALAR DIŞINDAKİ, HDD BOZUKLUKLARINDAN DOLAYI VE
                VİRÜSLERDEN DOLAYI BOZULMUŞ VERİ KAYIPLARINDAN ŞİRKETİMİZ SORUMLU DEĞİLDİR. MEYDANA GELEBİLECEK VERİ
                KAYIPLARINDAN ŞİRKETİMİZ SORUMLU DEĞİLDİR. YEDEKLEME İŞLEMİ ÜCRETE TABİDİR.</td>
        </tr>
    </tbody>
</table>