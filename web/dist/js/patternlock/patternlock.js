...
(function (factory) {
    ...
    function PatternLock(element, options) {
        ...
        if(!options.hasOwnProperty("onPattern")){
            options.onPattern = PatternLock.defaults.onPattern;
        }
        if(!options.hasOwnProperty("vibrate")){
            options.vibrate = PatternLock.defaults.vibrate;
        }
        if(!options.hasOwnProperty("interactable")){
            options.interactable = PatternLock.defaults.interactable;
        }
        //options = Object.assign(PatternLock.defaults, options || {})
       
        svg.on('touchstart mousedown', (e) => {
            console.log(options.interactable);
